                ...
                <div className="space-y-8 p-4">
                    <div className="">
                    {
                        ...
                        <div className="flex justify-center items-center mb-10">
                            <Link className="flex justify-center w-10/12 bg-gray-200 hover:bg-gray-100 transition-all ease-in-out duration-400 text-sm text-gray-950 rounded-lg p-3">Add Shipping Address</Link>
                        </div>
                    }
                    </div>
